...
✨|𝗔𝗻𝗶𝗤𝘂𝗶𝘇
━━━━━━━━━━━━━━━\n
𝖧𝖾𝗋𝖾 𝗂𝗌 𝗒𝗈𝗎𝗋 𝖺𝗇𝗂𝗆𝖾 𝗊𝗎𝗂𝗓, 𝗀𝗎𝖾𝗌𝗌 𝗍𝗁𝖾 𝖺𝗇𝗂𝗆𝖾 𝖼𝗈𝗋𝗋𝖾𝖼𝗍 𝗇𝖺𝗆𝖾 𝖺𝗇𝖽 𝗐𝗈𝗇 𝗆𝗈𝗇𝖾𝗒.

\n🔎|𝗧𝗿𝗮𝗶𝘁𝘀: ${traits}
\n🖇️|𝗧𝗮𝗴𝘀: ${tags}
\n𝖯𝗅𝖾𝖺𝗌𝖾 𝗋𝖾𝗉𝗅𝗒 𝗈𝗇 𝗍𝗁𝗂𝗌 𝗐𝗂𝗍𝗁 𝗒𝗈𝗎𝗋 𝖺𝗇𝗌𝗐𝖾𝗋.`;
  ...
  onReply: async function ({ message, event, Reply, api }) {
    try {
      ...
      if (correctAnswers.includes(userAnswer)) {
        await this.addCoins(event.senderID, 10000);
        await message.reply("🎉🎊 Congratulations! Your answer is correct.\nYou have received 10000 coins.");
      } else {
